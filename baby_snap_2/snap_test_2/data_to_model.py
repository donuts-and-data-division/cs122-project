...
with open(csv_file) as f:
    ...
    headers = ls[0]
    duplicates = [1508, 1306, 139, 167, 738, 1434, 125, 540, 1214, 1503, 306, 518, 835, 522, 982, 284, 393, 588, 274, 1745, 287, 1432, 1076, 1138, 189, 931, 1910, 316, 512, 1189, 490, 1338, 895, 332, 586, 2034]
